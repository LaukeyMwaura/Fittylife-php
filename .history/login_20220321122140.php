       ...
       <section class="francis-container">
           <div class="francis-row">
               ...
               <div class="francis-front">
                   ...
                   <form action="https://fityapi.azurewebsites.net/api/Authentication/Register" method="POST" enctype="multipart/form" >
               ...
               <div class="francis-back" >
                   <form action="https://fityapi.azurewebsites.net/api/Authentication/Login" method="post" enctype="multipart/form">
                       <div class="francis-form-holder">
